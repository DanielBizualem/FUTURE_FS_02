  ...
  return (
    <header className="h-16 bg-[#0f172a] flex items-center justify-between px-8 text-white shadow-lg">
      ...
      <div className="flex items-center gap-4">
        <button 
          type="button"
          onClick={onAddLead} // This calls the function passed from the page
          className="bg-yellow-400 hover:bg-yellow-500 text-black px-4 py-2 rounded-md text-sm font-bold flex items-center gap-2 transition-all active:scale-95"
        >
          <Plus size={18} />
          Add Lead
        </button>
